        ...
        <div className={`${className} ShearedTitle`} style={{fontSize: `${fontSize}px`, marginTop: `${fontSize}px`}}>
            { !shadow ? null :
                <div className="Shadow">
                    ...
                    <h2 className="Header2" style={{clipPath: `inset(${fontSize}px 0px ${fontSize / 2}px 0px)`}}>
                        {title}
                    </h2>
            ...
            <h2 className="Header2 ShadowMain" style={{color: 'white', clipPath: `inset(${fontSize}px 0px ${fontSize / 2}px 0px)`}}>
                {title}
            </h2>
